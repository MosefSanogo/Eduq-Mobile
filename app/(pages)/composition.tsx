...
const Composition = () => {
  ...
  const [items, setItems] = useState([
    { label: "Composition 1", value: "Composition 1" },
    { label: "Composition 2", value: "Composition 2" },
    { label: "Composition 3", value: "Composition 3" },
  ]);
  const [loader, setLoader] = useState(false);
  const [notes, setNotes] = useState([
    { id: 1, matiere: "Mathématiques", coef: 4, note: 12, comp: "Composition 1" },
    { id: 2, matiere: "Français", coef: 3, note: 15, comp: "Composition 1" },
    { id: 3, matiere: "Histoire", coef: 2, note: 9, comp: "Composition 2" },
    { id: 4, matiere: "Sciences", coef: 3, note: 14, comp: "Composition 1" },
    { id: 5, matiere: "Anglais", coef: 2, note: 11, comp: "Composition 2" },
    { id: 6, matiere: "Mathématiques", coef: 4, note: 12, comp: "Composition 1" },
  ]);
  const notesFiltered = useMemo(() => {
    ...
    return notes.filter((note) => note.comp === value);
  }, [value, notes]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {loader ? (
          (<ActivityIndicator  size="large" color={Colors[colorScheme].tint} style={{ marginVertical: 50 }} />)
        ) : (
